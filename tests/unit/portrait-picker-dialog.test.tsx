...
const portraits: GeneralPortrait[] = Array.from({ length: 4 }, (_, offset) => {
  ...
  return {
    ...
    thumbnail_url: `https://files.xbeaconai.com/system/portraits/${index}.png?x-tos-process=style/thumbnail`,
    display_url: `/portrait-${index}.jpg`,
    original_url: `https://files.xbeaconai.com/system/portraits/${index}.png`,
