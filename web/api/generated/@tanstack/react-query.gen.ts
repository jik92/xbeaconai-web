...
export const getProviderFeaturesQueryKey = (options?: Options<GetProviderFeaturesData>) => createQueryKey('getProviderFeatures', options);

export const getProviderFeaturesOptions = (options?: Options<GetProviderFeaturesData>) => queryOptions<GetProviderFeaturesResponse, DefaultError, GetProviderFeaturesResponse, ReturnType<typeof getProviderFeaturesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: getProviderFeaturesQueryKey(options)
});
...
export const getMediaUnderstandCapabilitiesQueryKey = (options?: Options<GetMediaUnderstandCapabilitiesData>) => createQueryKey('getMediaUnderstandCapabilities', options);

export const getMediaUnderstandCapabilitiesOptions = (options?: Options<GetMediaUnderstandCapabilitiesData>) => queryOptions<GetMediaUnderstandCapabilitiesResponse, DefaultError, GetMediaUnderstandCapabilitiesResponse, ReturnType<typeof getMediaUnderstandCapabilitiesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: getMediaUnderstandCapabilitiesQueryKey(options)
});

export const createMediaUnderstandJobMutation = (options?: Partial<Options<CreateMediaUnderstandJobData>>): UseMutationOptions<CreateMediaUnderstandJobResponse, CreateMediaUnderstandJobError, Options<CreateMediaUnderstandJobData>> => {
    const mutationOptions: UseMutationOptions<CreateMediaUnderstandJobResponse, CreateMediaUnderstandJobError, Options<CreateMediaUnderstandJobData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createMediaUnderstandJob({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const createAiGenerateJobMutation = (options?: Partial<Options<CreateAiGenerateJobData>>): UseMutationOptions<CreateAiGenerateJobResponse, CreateAiGenerateJobError, Options<CreateAiGenerateJobData>> => {
    const mutationOptions: UseMutationOptions<CreateAiGenerateJobResponse, CreateAiGenerateJobError, Options<CreateAiGenerateJobData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createAiGenerateJob({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listCustomPortraitsQueryKey = (options?: Options<ListCustomPortraitsData>) => createQueryKey('listCustomPortraits', options);

export const listCustomPortraitsOptions = (options?: Options<ListCustomPortraitsData>) => queryOptions<ListCustomPortraitsResponse, DefaultError, ListCustomPortraitsResponse, ReturnType<typeof listCustomPortraitsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listCustomPortraits({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listCustomPortraitsQueryKey(options)
});

export const registerCustomPortraitMutation = (options?: Partial<Options<RegisterCustomPortraitData>>): UseMutationOptions<RegisterCustomPortraitResponse, RegisterCustomPortraitError, Options<RegisterCustomPortraitData>> => {
    const mutationOptions: UseMutationOptions<RegisterCustomPortraitResponse, RegisterCustomPortraitError, Options<RegisterCustomPortraitData>> = {
        mutationFn: async (fnOptions) => {
...
export const getToolOutputFolderQueryKey = (options: Options<GetToolOutputFolderData>) => createQueryKey('getToolOutputFolder', options);

export const getToolOutputFolderOptions = (options: Options<GetToolOutputFolderData>) => queryOptions<GetToolOutputFolderResponse, GetToolOutputFolderError, GetToolOutputFolderResponse, ReturnType<typeof getToolOutputFolderQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getToolOutputFolder({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getToolOutputFolderQueryKey(options)
});

export const setToolOutputFolderMutation = (options?: Partial<Options<SetToolOutputFolderData>>): UseMutationOptions<SetToolOutputFolderResponse, SetToolOutputFolderError, Options<SetToolOutputFolderData>> => {
    const mutationOptions: UseMutationOptions<SetToolOutputFolderResponse, SetToolOutputFolderError, Options<SetToolOutputFolderData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setToolOutputFolder({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getAssetAccessQueryKey = (options: Options<GetAssetAccessData>) => createQueryKey('getAssetAccess', options);

export const getAssetAccessOptions = (options: Options<GetAssetAccessData>) => queryOptions<GetAssetAccessResponse, GetAssetAccessError, GetAssetAccessResponse, ReturnType<typeof getAssetAccessQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getAssetAccess({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getAssetAccessQueryKey(options)
});
...
export const exportAdminEnvKeyQueryKey = (options?: Options<ExportAdminEnvKeyData>) => createQueryKey('exportAdminEnvKey', options);

export const exportAdminEnvKeyOptions = (options?: Options<ExportAdminEnvKeyData>) => queryOptions<ExportAdminEnvKeyResponse, ExportAdminEnvKeyError, ExportAdminEnvKeyResponse, ReturnType<typeof exportAdminEnvKeyQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await exportAdminEnvKey({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: exportAdminEnvKeyQueryKey(options)
});

export const createDownloadTicketMutation = (options?: Partial<Options<CreateDownloadTicketData>>): UseMutationOptions<CreateDownloadTicketResponse, CreateDownloadTicketError, Options<CreateDownloadTicketData>> => {
    const mutationOptions: UseMutationOptions<CreateDownloadTicketResponse, CreateDownloadTicketError, Options<CreateDownloadTicketData>> = {
        mutationFn: async (fnOptions) => {
...
export const redeemDownloadTicketQueryKey = (options: Options<RedeemDownloadTicketData>) => createQueryKey('redeemDownloadTicket', options);

export const redeemDownloadTicketOptions = (options: Options<RedeemDownloadTicketData>) => queryOptions<RedeemDownloadTicketResponse, RedeemDownloadTicketError, RedeemDownloadTicketResponse, ReturnType<typeof redeemDownloadTicketQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await redeemDownloadTicket({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: redeemDownloadTicketQueryKey(options)
});
...
export const getAdminCredentialDoctorResultsQueryKey = (options?: Options<GetAdminCredentialDoctorResultsData>) => createQueryKey('getAdminCredentialDoctorResults', options);

export const getAdminCredentialDoctorResultsOptions = (options?: Options<GetAdminCredentialDoctorResultsData>) => queryOptions<GetAdminCredentialDoctorResultsResponse, GetAdminCredentialDoctorResultsError, GetAdminCredentialDoctorResultsResponse, ReturnType<typeof getAdminCredentialDoctorResultsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getAdminCredentialDoctorResults({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getAdminCredentialDoctorResultsQueryKey(options)
});

export const runAdminCredentialDoctorMutation = (options?: Partial<Options<RunAdminCredentialDoctorData>>): UseMutationOptions<RunAdminCredentialDoctorResponse, RunAdminCredentialDoctorError, Options<RunAdminCredentialDoctorData>> => {
    const mutationOptions: UseMutationOptions<RunAdminCredentialDoctorResponse, RunAdminCredentialDoctorError, Options<RunAdminCredentialDoctorData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await runAdminCredentialDoctor({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listAdminProviderAuditsQueryKey = (options?: Options<ListAdminProviderAuditsData>) => createQueryKey('listAdminProviderAudits', options);

export const listAdminProviderAuditsOptions = (options?: Options<ListAdminProviderAuditsData>) => queryOptions<ListAdminProviderAuditsResponse, ListAdminProviderAuditsError, ListAdminProviderAuditsResponse, ReturnType<typeof listAdminProviderAuditsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listAdminProviderAudits({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
...
export const listAdminProviderAuditsInfiniteOptions = (options?: Options<ListAdminProviderAuditsData>) => {
    const opts = infiniteQueryOptions<ListAdminProviderAuditsResponse, ListAdminProviderAuditsError, InfiniteData<ListAdminProviderAuditsResponse>, QueryKey<Options<ListAdminProviderAuditsData>>, number | Pick<QueryKey<Options<ListAdminProviderAuditsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListAdminProviderAuditsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: listAdminProviderAuditsInfiniteQueryKey(options)
    });
    return opts as Omit<typeof opts, 'initialData'>;
};

export const getAdminProviderAuditQueryKey = (options: Options<GetAdminProviderAuditData>) => createQueryKey('getAdminProviderAudit', options);

export const getAdminProviderAuditOptions = (options: Options<GetAdminProviderAuditData>) => queryOptions<GetAdminProviderAuditResponse, GetAdminProviderAuditError, GetAdminProviderAuditResponse, ReturnType<typeof getAdminProviderAuditQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getAdminProviderAudit({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getAdminProviderAuditQueryKey(options)
});
...
export const releaseAdminUsersMutation = (options?: Partial<Options<ReleaseAdminUsersData>>): UseMutationOptions<ReleaseAdminUsersResponse, ReleaseAdminUsersError, Options<ReleaseAdminUsersData>> => {
    const mutationOptions: UseMutationOptions<ReleaseAdminUsersResponse, ReleaseAdminUsersError, Options<ReleaseAdminUsersData>> = {
        mutationFn: async (fnOptions) => {
...
export const stopAllAdminJobsMutation = (options?: Partial<Options<StopAllAdminJobsData>>): UseMutationOptions<StopAllAdminJobsResponse, StopAllAdminJobsError, Options<StopAllAdminJobsData>> => {
    const mutationOptions: UseMutationOptions<StopAllAdminJobsResponse, StopAllAdminJobsError, Options<StopAllAdminJobsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await stopAllAdminJobs({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const createScriptRemixNextProjectMutation = (options?: Partial<Options<CreateScriptRemixNextProjectData>>): UseMutationOptions<CreateScriptRemixNextProjectResponse, CreateScriptRemixNextProjectError, Options<CreateScriptRemixNextProjectData>> => {
    const mutationOptions: UseMutationOptions<CreateScriptRemixNextProjectResponse, CreateScriptRemixNextProjectError, Options<CreateScriptRemixNextProjectData>> = {
        mutationFn: async (fnOptions) => {
...
export const regenerateScriptRemixNextAnalysisMutation = (options?: Partial<Options<RegenerateScriptRemixNextAnalysisData>>): UseMutationOptions<RegenerateScriptRemixNextAnalysisResponse, RegenerateScriptRemixNextAnalysisError, Options<RegenerateScriptRemixNextAnalysisData>> => {
    const mutationOptions: UseMutationOptions<RegenerateScriptRemixNextAnalysisResponse, RegenerateScriptRemixNextAnalysisError, Options<RegenerateScriptRemixNextAnalysisData>> = {
        mutationFn: async (fnOptions) => {
...
export const updateScriptRemixNextProjectMutation = (options?: Partial<Options<UpdateScriptRemixNextProjectData>>): UseMutationOptions<UpdateScriptRemixNextProjectResponse, UpdateScriptRemixNextProjectError, Options<UpdateScriptRemixNextProjectData>> => {
    const mutationOptions: UseMutationOptions<UpdateScriptRemixNextProjectResponse, UpdateScriptRemixNextProjectError, Options<UpdateScriptRemixNextProjectData>> = {
        mutationFn: async (fnOptions) => {
...
export const createScriptRemixNextStoryboardMutation = (options?: Partial<Options<CreateScriptRemixNextStoryboardData>>): UseMutationOptions<CreateScriptRemixNextStoryboardResponse, CreateScriptRemixNextStoryboardError, Options<CreateScriptRemixNextStoryboardData>> => {
    const mutationOptions: UseMutationOptions<CreateScriptRemixNextStoryboardResponse, CreateScriptRemixNextStoryboardError, Options<CreateScriptRemixNextStoryboardData>> = {
        mutationFn: async (fnOptions) => {
...
export const createScriptRemixNextReferenceImageMutation = (options?: Partial<Options<CreateScriptRemixNextReferenceImageData>>): UseMutationOptions<CreateScriptRemixNextReferenceImageResponse, CreateScriptRemixNextReferenceImageError, Options<CreateScriptRemixNextReferenceImageData>> => {
    const mutationOptions: UseMutationOptions<CreateScriptRemixNextReferenceImageResponse, CreateScriptRemixNextReferenceImageError, Options<CreateScriptRemixNextReferenceImageData>> = {
        mutationFn: async (fnOptions) => {
...
export const createScriptRemixNextShotGenerationMutation = (options?: Partial<Options<CreateScriptRemixNextShotGenerationData>>): UseMutationOptions<CreateScriptRemixNextShotGenerationResponse, CreateScriptRemixNextShotGenerationError, Options<CreateScriptRemixNextShotGenerationData>> => {
    const mutationOptions: UseMutationOptions<CreateScriptRemixNextShotGenerationResponse, CreateScriptRemixNextShotGenerationError, Options<CreateScriptRemixNextShotGenerationData>> = {
        mutationFn: async (fnOptions) => {
...
export const createScriptRemixNextComposeMutation = (options?: Partial<Options<CreateScriptRemixNextComposeData>>): UseMutationOptions<CreateScriptRemixNextComposeResponse, CreateScriptRemixNextComposeError, Options<CreateScriptRemixNextComposeData>> => {
    const mutationOptions: UseMutationOptions<CreateScriptRemixNextComposeResponse, CreateScriptRemixNextComposeError, Options<CreateScriptRemixNextComposeData>> = {
        mutationFn: async (fnOptions) => {
...
export const listVideoRemixProjectsQueryKey = (options?: Options<ListVideoRemixProjectsData>) => createQueryKey('listVideoRemixProjects', options);

export const listVideoRemixProjectsOptions = (options?: Options<ListVideoRemixProjectsData>) => queryOptions<ListVideoRemixProjectsResponse, DefaultError, ListVideoRemixProjectsResponse, ReturnType<typeof listVideoRemixProjectsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listVideoRemixProjects({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listVideoRemixProjectsQueryKey(options)
});

export const listVideoRemixProjectsInfiniteQueryKey = (options?: Options<ListVideoRemixProjectsData>): QueryKey<Options<ListVideoRemixProjectsData>> => createQueryKey('listVideoRemixProjects', options, true);

export const listVideoRemixProjectsInfiniteOptions = (options?: Options<ListVideoRemixProjectsData>) => {
    const opts = infiniteQueryOptions<ListVideoRemixProjectsResponse, DefaultError, InfiniteData<ListVideoRemixProjectsResponse>, QueryKey<Options<ListVideoRemixProjectsData>>, number | Pick<QueryKey<Options<ListVideoRemixProjectsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListVideoRemixProjectsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: listVideoRemixProjectsInfiniteQueryKey(options)
    });
    return opts as Omit<typeof opts, 'initialData'>;
};

export const getVideoRemixProjectQueryKey = (options: Options<GetVideoRemixProjectData>) => createQueryKey('getVideoRemixProject', options);

export const getVideoRemixProjectOptions = (options: Options<GetVideoRemixProjectData>) => queryOptions<GetVideoRemixProjectResponse, GetVideoRemixProjectError, GetVideoRemixProjectResponse, ReturnType<typeof getVideoRemixProjectQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getVideoRemixProject({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getVideoRemixProjectQueryKey(options)
});

export const updateVideoRemixProjectMutation = (options?: Partial<Options<UpdateVideoRemixProjectData>>): UseMutationOptions<UpdateVideoRemixProjectResponse, UpdateVideoRemixProjectError, Options<UpdateVideoRemixProjectData>> => {
    const mutationOptions: UseMutationOptions<UpdateVideoRemixProjectResponse, UpdateVideoRemixProjectError, Options<UpdateVideoRemixProjectData>> = {
        mutationFn: async (fnOptions) => {
...
export const createVideoRemixPromptToolJobMutation = (options?: Partial<Options<CreateVideoRemixPromptToolJobData>>): UseMutationOptions<CreateVideoRemixPromptToolJobResponse, CreateVideoRemixPromptToolJobError, Options<CreateVideoRemixPromptToolJobData>> => {
    const mutationOptions: UseMutationOptions<CreateVideoRemixPromptToolJobResponse, CreateVideoRemixPromptToolJobError, Options<CreateVideoRemixPromptToolJobData>> = {
        mutationFn: async (fnOptions) => {
...
export const createVideoRemixShotGenerationJobMutation = (options?: Partial<Options<CreateVideoRemixShotGenerationJobData>>): UseMutationOptions<CreateVideoRemixShotGenerationJobResponse, CreateVideoRemixShotGenerationJobError, Options<CreateVideoRemixShotGenerationJobData>> => {
    const mutationOptions: UseMutationOptions<CreateVideoRemixShotGenerationJobResponse, CreateVideoRemixShotGenerationJobError, Options<CreateVideoRemixShotGenerationJobData>> = {
        mutationFn: async (fnOptions) => {
...
export const listVideoRemixShotGenerationJobsQueryKey = (options: Options<ListVideoRemixShotGenerationJobsData>) => createQueryKey('listVideoRemixShotGenerationJobs', options);

export const listVideoRemixShotGenerationJobsOptions = (options: Options<ListVideoRemixShotGenerationJobsData>) => queryOptions<ListVideoRemixShotGenerationJobsResponse, ListVideoRemixShotGenerationJobsError, ListVideoRemixShotGenerationJobsResponse, ReturnType<typeof listVideoRemixShotGenerationJobsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: listVideoRemixShotGenerationJobsQueryKey(options)
});

export const createVideoRemixComposeJobMutation = (options?: Partial<Options<CreateVideoRemixComposeJobData>>): UseMutationOptions<CreateVideoRemixComposeJobResponse, CreateVideoRemixComposeJobError, Options<CreateVideoRemixComposeJobData>> => {
    const mutationOptions: UseMutationOptions<CreateVideoRemixComposeJobResponse, CreateVideoRemixComposeJobError, Options<CreateVideoRemixComposeJobData>> = {
        mutationFn: async (fnOptions) => {
...
export const clearVideoCreateScriptMutation = (options?: Partial<Options<ClearVideoCreateScriptData>>): UseMutationOptions<ClearVideoCreateScriptResponse, ClearVideoCreateScriptError, Options<ClearVideoCreateScriptData>> => {
    const mutationOptions: UseMutationOptions<ClearVideoCreateScriptResponse, ClearVideoCreateScriptError, Options<ClearVideoCreateScriptData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await clearVideoCreateScript({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getVideoCreateShotGenerationDraftQueryKey = (options: Options<GetVideoCreateShotGenerationDraftData>) => createQueryKey('getVideoCreateShotGenerationDraft', options);

export const getVideoCreateShotGenerationDraftOptions = (options: Options<GetVideoCreateShotGenerationDraftData>) => queryOptions<GetVideoCreateShotGenerationDraftResponse, GetVideoCreateShotGenerationDraftError, GetVideoCreateShotGenerationDraftResponse, ReturnType<typeof getVideoCreateShotGenerationDraftQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getVideoCreateShotGenerationDraft({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getVideoCreateShotGenerationDraftQueryKey(options)
});
...
export const batchGenerateVideoCreateShotsMutation = (options?: Partial<Options<BatchGenerateVideoCreateShotsData>>): UseMutationOptions<BatchGenerateVideoCreateShotsResponse, BatchGenerateVideoCreateShotsError, Options<BatchGenerateVideoCreateShotsData>> => {
    const mutationOptions: UseMutationOptions<BatchGenerateVideoCreateShotsResponse, BatchGenerateVideoCreateShotsError, Options<BatchGenerateVideoCreateShotsData>> = {
        mutationFn: async (fnOptions) => {
...
export const listVideoCreateShotMaterialVersionsQueryKey = (options: Options<ListVideoCreateShotMaterialVersionsData>) => createQueryKey('listVideoCreateShotMaterialVersions', options);

export const listVideoCreateShotMaterialVersionsOptions = (options: Options<ListVideoCreateShotMaterialVersionsData>) => queryOptions<ListVideoCreateShotMaterialVersionsResponse, ListVideoCreateShotMaterialVersionsError, ListVideoCreateShotMaterialVersionsResponse, ReturnType<typeof listVideoCreateShotMaterialVersionsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: listVideoCreateShotMaterialVersionsQueryKey(options)
});

export const applyVideoCreateShotMaterialVersionMutation = (options?: Partial<Options<ApplyVideoCreateShotMaterialVersionData>>): UseMutationOptions<ApplyVideoCreateShotMaterialVersionResponse, ApplyVideoCreateShotMaterialVersionError, Options<ApplyVideoCreateShotMaterialVersionData>> => {
    const mutationOptions: UseMutationOptions<ApplyVideoCreateShotMaterialVersionResponse, ApplyVideoCreateShotMaterialVersionError, Options<ApplyVideoCreateShotMaterialVersionData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await applyVideoCreateShotMaterialVersion({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const processVideoCreateShotMaterialMutation = (options?: Partial<Options<ProcessVideoCreateShotMaterialData>>): UseMutationOptions<ProcessVideoCreateShotMaterialResponse, ProcessVideoCreateShotMaterialError, Options<ProcessVideoCreateShotMaterialData>> => {
    const mutationOptions: UseMutationOptions<ProcessVideoCreateShotMaterialResponse, ProcessVideoCreateShotMaterialError, Options<ProcessVideoCreateShotMaterialData>> = {
        mutationFn: async (fnOptions) => {
...
export const updateAllVideoCreateShotSettingsMutation = (options?: Partial<Options<UpdateAllVideoCreateShotSettingsData>>): UseMutationOptions<UpdateAllVideoCreateShotSettingsResponse, UpdateAllVideoCreateShotSettingsError, Options<UpdateAllVideoCreateShotSettingsData>> => {
...
export const preflightQwenVoiceSampleMutation = (options?: Partial<Options<PreflightQwenVoiceSampleData>>): UseMutationOptions<PreflightQwenVoiceSampleResponse, PreflightQwenVoiceSampleError, Options<PreflightQwenVoiceSampleData>> => {
    const mutationOptions: UseMutationOptions<PreflightQwenVoiceSampleResponse, PreflightQwenVoiceSampleError, Options<PreflightQwenVoiceSampleData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await preflightQwenVoiceSample({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getArtifactAccessQueryKey = (options: Options<GetArtifactAccessData>) => createQueryKey('getArtifactAccess', options);

export const getArtifactAccessOptions = (options: Options<GetArtifactAccessData>) => queryOptions<GetArtifactAccessResponse, GetArtifactAccessError, GetArtifactAccessResponse, ReturnType<typeof getArtifactAccessQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getArtifactAccess({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getArtifactAccessQueryKey(options)
});
