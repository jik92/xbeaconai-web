...
export const sdkRegistry: SdkRegistryEntry[] = [
  ...
  },
  {
    ...
    enabled: true,
    required: true,
    testAdapter: "test-image-openai",
  },
  {
    id: "aihubmix-image-seedream-5-lite",
    implementationPath: "server/providers/aihubmix.ts",
    kind: "model",
    capability: "image-generate",
    provider: "aihubmix",
    ...
    enabled: true,
    required: true,
    testAdapter: "test-image-seedream",
  },
  {
    id: "aihubmix-image-seedream-4-5",
    implementationPath: "server/providers/aihubmix.ts",
    kind: "model",
    capability: "image-generate",
    provider: "aihubmix",
  ...
  {
    id: "aihubmix-image-seedream-4-0",
    implementationPath: "server/providers/aihubmix.ts",
    kind: "model",
    capability: "image-generate",
    provider: "aihubmix",
  ...
  {
    id: "aihubmix-image-nano-banana-2",
    implementationPath: "server/providers/aihubmix.ts",
    kind: "model",
    capability: "image-generate",
    provider: "aihubmix",
    ...
    enabled: true,
    required: true,
    testAdapter: "test-image-gemini-interactions",
  },
  {
    id: "aihubmix-image-nano-banana-pro",
    implementationPath: "server/providers/aihubmix.ts",
    kind: "model",
    capability: "image-generate",
    provider: "aihubmix",
    ...
    enabled: true,
    required: true,
    testAdapter: "test-image-gemini-content",
  },
  {
    id: "aihubmix-image-gpt-2",
    implementationPath: "server/providers/aihubmix.ts",
    kind: "model",
    capability: "image-generate",
    provider: "aihubmix",
    ...
    enabled: true,
    required: true,
    testAdapter: "test-image-openai-edit",
  },
  {
    id: "aihubmix-audio",
    implementationPath: "server/providers/aihubmix.ts",
