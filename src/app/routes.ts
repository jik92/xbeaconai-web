  ...
  module({
    ...
    fields: [
      ...
      { id: "count", label: "裂变数量", kind: "number", required: true, min: 3, max: 50, unit: "条" },
      {
        ...
        kind: "segmented",
        required: true,
        options: ["开场钩子", "标题与字幕", "镜头顺序", "全部维度"],
      },
      {
        id: "audiences",
        label: "目标人群组",
        kind: "textarea",
        placeholder: "每行一个人群，例如：宝妈、学生、职场新人",
      },
      {
        id: "duplicate",
        label: "平台查重策略",
