...
type ComingSoonFeature = Pick<ModuleConfig,"id"|"label"> | {id:"portraits";label:"人像库"};

export function ComingSoonPage({config}:{config:ComingSoonFeature}){
  return <section className="coming-soon-page" data-module-id={config.id}>
    <div className="coming-soon-icon"><Clock3/></div>
...
export function ProjectComingSoonPage(){
  return <section className="coming-soon-page" data-module-id="project">
    <div className="coming-soon-icon"><Clock3/></div>
    <span>COMING SOON</span>
